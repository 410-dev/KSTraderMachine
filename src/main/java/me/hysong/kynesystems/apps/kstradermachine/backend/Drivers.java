...
public class Drivers {
    ...
    private static DriverLoader classLoader = new DriverLoader(new URL[]{}, KSTraderMachine.class.getClassLoader());
    ...
    public static void coreComponent(String pathToJar) throws Exception{
        ...
        if (classLoader == null) {
            classLoader = new DriverLoader(new URL[]{jarUrl}, KSTraderMachine.class.getClassLoader());
        } else {
