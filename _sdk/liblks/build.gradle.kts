...
val copyDriver by tasks.registering(Copy::class) {
    group = "distribution"
    description = "Copies the built liblks.jar to the shared Storage/libraries directory"
    from(layout.buildDirectory.file("../../../builds/libraries/liblks.jar"))
