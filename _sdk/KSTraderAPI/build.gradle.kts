...
tasks.withType<ShadowJar>().configureEach {
    ...
    archiveBaseName.set("KSTraderAPI")
    archiveVersion.set("")
...
val copyDriver by tasks.registering(Copy::class) {
    group = "distribution"
    description = "Copies the built KSTraderAPI.jar to the shared Storage/libraries directory"
    from(layout.buildDirectory.file("../../../builds/libraries/KSTraderAPI.jar"))
